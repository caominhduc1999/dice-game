<template>
    <div class="wrapper-controls">
        ...
        <button v-on:click="holdScore" class="control btn-hold"><i class="ion-ios-download-outline"></i>Hold</button>

        <input
            v-bind:disabled="isPlaying"
            v-bind:value="finalScore"
            v-on:input="$emit('handleChangeScore', $event)"
...
<script>
    export default {
        ...
        methods:{
            newGame(){
                //kich hoat su kien handleNewGame
